...
// no bundler, so would have to import directly from the web inside of using node_modules
import * as d3 from "https://cdn.skypack.dev/d3@7";

export const createD3CircleSvg = (data) => {
  //
  ...
  node.append("circle")
      .attr("fill", d => d.children ? "#a55a76" : "#a55a76")
      .attr("stroke", d => d.children ? "#a55a76" : d.data.color)
      .attr("stroke-width", d => d.children ? 0 : Math.sqrt(d.data.value)*2 )
      .attr("r", d => d.r);
  // .attr("r", 10);
